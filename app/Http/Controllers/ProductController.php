...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('products.create')->with("customFields", isset($html) ? $html : false)->with("market", $market)->with("category", $category)->with("data",$data);
    }
    ...
    public function store(CreateProductRequest $request)
    {
        ...
        $customFields = $this->customFieldRepository->findByField('custom_field_model', $this->productRepository->model());
        try {
            foreach ($input['market_id'] as $key => $val) {
                $product = $this->productRepository->create([
                    ...
                    'package_items_count' => $input["package_items_count"],
                    'unit' => $input["unit"],
    ...
    public function edit($id)
    {
        ...
        return view('products.edit')->with('product', $product)->with("customFields", isset($html) ? $html : false)->with("market", $market)->with("category", $category)->with("data",$data);
    }
    ...
    public function update($id, UpdateProductRequest $request)
    {
        ...
        try {
            if($input['copy_market_id'] == null){
                ...
                'featured' => $input["featured"],
                'deliverable' => $input["deliverable"],
                'market_id' => $input['copy_market_id'],
                'category_id' => $input["category_id"],
                ]);
            }
